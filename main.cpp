...
void end(double score) //displays the end page and displays the final score
{
	...
	rect.imprint();
	rect.reset(0,0,0,0);
	Text final(650,350,"arrow didn't hit the board... your chances over");
	final.imprint();
...
void help() // explains some of the rules of game
{
	...
	t1.imprint();
	Text t2(600,240,"-->If Arrow  misses the board 3 times, your game over");
	t2.imprint();
	Text t3(580,260,"-->The value of gravity is random...be cautious");
	t3.imprint();
	int where=getClick(); 
...
void home() // its the introduction page
{
	...
	button level0_button(520,256.666,260,93.333,"****LEVEL0****",rc0);
	button level1_button(780,256.666,260,93.333,"****LEVEL1****",rc0);
